...
async function addWelcome(jid, enabled, message) {
    try {
        ...
        data.welcome[jid] = {
            enabled: enabled,
            message: message || '🌟 *W A R M  W E L C O M E* 🌟\n🛡️ User: {user}\n 🏰 Welcome to: {group}\nWe hope youll find this group engaging, helpful, and full of positive vibes! Your presence adds value to our community.\n📜 Message:\n{description}\n_',
            channelId: '120363418156081092@newsletter'
        };
